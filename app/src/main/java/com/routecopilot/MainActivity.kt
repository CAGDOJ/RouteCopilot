...
class MainActivity : ComponentActivity(), LocationListener {
    ...
    override fun onResume() {
        ...
        // Se uma fila de WhatsApp estiver em andamento,
        // ao voltar abre automaticamente o prÃ³ximo cliente.
        CustomerMessaging.onHostResume(this)
    }
    ...
    private fun startCourierTracking() {
        ...
        if (
            ...
            Toast.makeText(
                this,
                "Permita a localizaÃ§Ã£o para iniciar o rastreamento.",
                Toast.LENGTH_LONG
            ).show()
...
private fun HomeScreen(
    ...
    AppScaffold {
        BrandHeader(
            "Sua rota mais simples, suas entregas mais rÃ¡pidas."
        )
        ...
        Card(
            ...
            Column(
                ...
                ActionCard(
                    ...
                    subtitle = "DisponÃ­vel apÃ³s importar os pedidos",
                    onClick = {
                        if (hasRoute) {
                            onOpenMessages()
                        } else {
        ...
        when (state) {
            SpxState.LOGIN_REQUIRED ->
                InfoCard(
                    ...
                    text = "FaÃ§a o login normalmente no SPX. Senha e cÃ³digos de verificaÃ§Ã£o nÃ£o sÃ£o lidos pelo RouteCopilot.",
                    warning = true
                )
            ...
            SpxState.ERROR ->
                ...
                InfoCard(
                    title = "Leitura automÃ¡tica",
                    text = "A tela sÃ³ avanÃ§a quando o serviÃ§o realmente reconhece uma etapa no SPX.",
                    warning = false
                )
        }
...
private fun RouteScreen(
    ...
    AppScaffold {
            ...
            Column(
                ...
                Row(
                    ...
                    Column {
                        ...
                        Text(
                            text = "Data: ${date ?: "NÃ£o identificada"}",
                            color = AppMuted,
                            fontSize = 12.sp
                        )
                        ...
                        Text(
                            text = "EndereÃ§os no mapa: $geocoded / ${stops.size}",
                            color = AppMuted,
                            fontSize = 12.sp
                        )
                    }
        ...
        ActionCard(
            icon = R.drawable.ic_message,
            iconColor = AppGreen,
            title = "Disparar mensagem de inÃ­cio para todos",
            subtitle = "Inicia a fila com um link individual para cada cliente",
        ...
        ActionCard(
            icon = R.drawable.ic_message,
            iconColor = AppBlue,
            title = "Mensagens e avisos individuais",
            subtitle = "Reenviar mensagem ou avisar que Ã© a prÃ³xima parada",
        ...
        ActionCard(
            ...
            subtitle = "MantÃ©m posiÃ§Ã£o e ETA dos links enviados atualizados",
        ...
        if (occurrenceDescriptions.isNotEmpty()) {
            ...
            if (occurrenceDescriptions.size > 5) {
                Text(
                    text = "+ ${occurrenceDescriptions.size - 5} descriÃ§Ãµes",
                    color = AppOrange,
                    fontWeight = FontWeight.Bold,
                    fontSize = 12.sp
                )
        ...
        stops
            ...
            .forEachIndexed { index, stop ->
                PackageRow(
                    ...
                    name = stop.recipient ?: "NÃ£o identificado",
                    address = stop.address ?: "NÃ£o identificado",
                    neighborhood = stop.neighborhood ?: "NÃ£o identificado",
                    next = index == 0
                )
    ...
    Column(
        ...
        Column(
            ...
            if (
                ...
                InfoCard(
                    title = "EndereÃ§os nÃ£o localizados",
                    text = "O SPX importou os pedidos, mas ainda nÃ£o foi possÃ­vel obter coordenadas suficientes para desenhar o mapa.",
                    warning = true
                )
...
private fun MessagesScreen(
    ...
    Column(
        ...
        if (TrackingConfig.BASE_URL.isBlank()) {
            InfoCard(
                title = "Link pÃºblico ainda nÃ£o publicado",
                text = "As mensagens e o ETA funcionam. Para o cliente abrir o mapa ao vivo, publique o backend incluÃ­do no pacote e informe a URL em TrackingConfig.kt.",
                warning = true
            )
        ...
        PrimaryButton(
            text = "DISPARAR MENSAGEM PARA TODOS",
            icon = R.drawable.ic_message,
            color = AppGreen,
            onClick = {
                // Liga o rastreamento antes da fila para a pÃ¡gina web
                // comeÃ§ar a receber posiÃ§Ã£o/ETA imediatamente.
                onStartTracking()
                CustomerMessaging.startBatch(
                    context = context,
                    stops = ordered
...
private fun MessageStopCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "PrevisÃ£o: aproximadamente $eta min",
                color = AppOrange,
                fontWeight = FontWeight.Bold,
                fontSize = 12.sp
            )
            ...
            PrimaryButton(
                text = "AVISAR: SUA ENTREGA Ã‰ A PRÃ“XIMA",
                icon = R.drawable.ic_navigation,
                color = AppBlue,
                onClick = onNext
            )
...
fun abrirConfiguracaoAcessibilidade(
    ...
    runCatching {
        ...
        Toast.makeText(
            context,
            "NÃ£o foi possÃ­vel abrir as configuraÃ§Ãµes de acessibilidade.",
            Toast.LENGTH_LONG
        ).show()
    }
}
...
fun abrirSPX(
    ...
    if (intent == null) {
        Toast.makeText(
            context,
            "SPX nÃ£o encontrado neste aparelho.",
            Toast.LENGTH_LONG
        ).show()
