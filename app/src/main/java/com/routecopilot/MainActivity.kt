...
class MainActivity : ComponentActivity() {
    ...
    private val accessibilityAtiva: MutableState<Boolean> =
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            RouteCopilotTheme {
                ...
                RouteCopilotApp(
                    accessibilityAtiva = accessibilityAtiva.value
                )
            }
        }
    }
...
fun RouteCopilotApp(
    ...
    LaunchedEffect(spxState) {
        ...
        if (
            spxState == SpxState.IMPORT_COMPLETE ||
            spxState == SpxState.RETURNING_TO_COPILOT ||
            spxState == SpxState.ROUTE_READY
        ) {
            tela = "gestao"
        }
    }
...
fun HomeScreen(
    ...
    Column(
        ...
        Text(
            text = "Operação inteligente de entregas",
            color = Muted,
            fontSize = 15.sp
        )
        ...
        RouteCard(
            ...
            description = "Nenhuma rota ativa no momento"
        )
...
fun ImportRouteScreen(
    ...
    var spxAberto by remember {
        mutableStateOf(false)
    }

    LaunchedEffect(accessibilityAtiva) {
    ...
    Column(
        ...
        Text(
            text = "O Copilot acompanha a importação e retorna para a gestão quando terminar.",
            color = Muted,
            fontSize = 14.sp
        )
        ...
        if (!accessibilityAtiva) {
            ...
            Column(
                ...
                if (state == SpxState.LOGIN_REQUIRED) {
                    ...
                    Text(
                        text = "Faça a autenticação normalmente no próprio SPX. O Copilot continuará depois do login.",
                        color = Warning,
                        fontSize = 13.sp
                    )
                }
        ...
        Column(
            ...
            Row(
                ...
                InfoBlock(
                    ...
                    label = "CARREGAMENTO",
                    value = data ?: "Não identificado"
                )

                InfoBlock(
                    modifier = Modifier.weight(1f),
                    label = "PEDIDOS",
                    value = totalExibido.toString()
                )
            }
...
fun PermissionCard(
    ...
    Column(
        ...
        Text(
            text = "Ativar integração com SPX",
            color = White,
            fontSize = 20.sp,
            fontWeight = FontWeight.Bold
        )
        ...
        Text(
            text = "O Android exige que o serviço de acessibilidade seja ativado manualmente. Depois de ativado, o Copilot detecta automaticamente.",
            color = Muted,
            fontSize = 14.sp
        )
