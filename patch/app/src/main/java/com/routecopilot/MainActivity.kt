...
class MainActivity : ComponentActivity(), LocationListener {
    ...
    override fun onResume() {
        ...
        // ao voltar abre automaticamente o próximo cliente.
...
private fun RouteScreen(
    ...
    AppScaffold {
        ...
        ActionCard(
            icon = R.drawable.ic_message,
            iconColor = AppGreen,
            title = "Disparar mensagem de início para todos",
        ...
        ActionCard(
            ...
            subtitle = "Reenviar mensagem ou avisar que é a próxima parada",
...
private fun MessagesScreen(
    ...
    Column(
        ...
        PrimaryButton(
            ...
            color = AppGreen,
            onClick = {
                // Liga o rastreamento antes da fila para a página web
                // começar a receber posição/ETA imediatamente.
                onStartTracking()
                CustomerMessaging.startBatch(
                    context = context,
                    stops = ordered
